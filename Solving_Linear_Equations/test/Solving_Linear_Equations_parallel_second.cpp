...
//double Solving_Linear_Equations_parallel_second::multiply_row_by_column(const std::vector<double>& row, const std::vector<double>& column, int count) const
//{
//	double result = 0.0;
...
//	{
//		x_process[j] += multiply_row_by_column(A[i], x, count_for_process);
//	}
